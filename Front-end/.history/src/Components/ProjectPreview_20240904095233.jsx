        ...
        <div className="projectTechnology">
          ...
          <div className="icons">
            ...
            {skills?.includes("Html") ? (
              <TiHtml5 className="techName skills html" />
            ) : null}
            {skills?.includes("Css") ? (
              <IoLogoCss3 className="techName skills css" />
            ) : null}
            {skills?.includes("Js") ? (
              <SiJavascript className="techName skills js" />
            ) : null}
            {skills?.includes("React") ? (
              <IoLogoReact className="techName skills react" />
            ) : null}
            {skills?.includes("Wordpress") ? (
              <IoLogoWordpress className="techName skills wordpress" />
            ) : null}
            {skills?.includes("Node") ? (
              <IoLogoNodejs className="techName skills node" />
            ) : null}
            {skills?.includes("MongoDb") ? (
              <SiMongodb className="techName skills mongodb" />
            ) : null}
            {/* </div> */}
          </div>
        </div>
