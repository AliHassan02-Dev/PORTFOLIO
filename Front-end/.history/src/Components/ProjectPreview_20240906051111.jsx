        ...
        <div className="projectTechnology">
          ...
          <div className="icons">
            {skills?.includes("Html") ? (
              <TiHtml5 className="techName skillee html" />
            ) : null}
            {skills?.includes("Css") ? (
              <IoLogoCss3 className="techName skillee css" />
            ) : null}
            {skills?.includes("Js") ? (
              <SiJavascript className="techName skillee js" />
            ) : null}
            {skills?.includes("React") ? (
              <IoLogoReact className="techName skillee react" />
            ) : null}
            {skills?.includes("Wordpress") ? (
              <IoLogoWordpress className="techName skillee wordpress" />
            ) : null}
            {skills?.includes("Node") ? (
              <IoLogoNodejs className="techName skillee node" />
            ) : null}
            {skills?.includes("MongoDb") ? (
              <SiMongodb className="techName skillee mongodb" />
            ) : null}
          </div>
        </div>
        <div className="links">
          ...
          <div className="icons">
            {data?.links[0] ? (
              <Link target={"_blank"} to={data?.links[0]}>
                <FaFigma className="techName skillee figma" />
              </Link>
            ) : null}
            {data?.links[1] ? (
              <Link target={"_blank"} to={data?.links[1]}>
                <RiGlobalLine className="techName  skillee website" />
              </Link>
            ) : null}
          </div>
        </div>
