...
const AdminDashboard = () => {
  ...
  // FOR IMAGE UPLOADING
  const [fullProjectImage, setFullProjectImage] = useState("");
  ...
  const handleFileChangeOne = (e) => {
    ...
    reader.onload = () => {
      setFullProjectImage(reader.result);
    };
    reader.onerror = () => {
      console.log("Error", error);
    };

    console.log(fullProjectImage);
  };
        ...
        <div className="midContainer">
          <div className="imageBox">
            <div className="image">
              ...
              />
              <button onClick={handleButtonClickOne}>Upload Full Project</button>
            </div>
            <div className="image">
              <FiUploadCloud className="uploadIcon" />
              <input
              ...
              />
              <button onClick={handleButtonClickTwp}>
