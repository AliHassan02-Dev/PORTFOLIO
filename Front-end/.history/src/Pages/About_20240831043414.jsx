  ...
  return (
    <div className="aboutContainer containers">
      <div className="left">
        ...
        <p id="aboutAni">
          <span>Introduction</span> <br /> My name is Ali Hassan Siddiqui. I am fresher with
          a skills of web development and designing. I did a web designing
          course of 6 Months. Below are some the projects I created as a
          pratice.
        </p>
