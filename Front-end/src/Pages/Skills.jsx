...
const Skills = () => {
  ...
  return (
    <div className="skillsContainer containers" id="skillsSect">
      <div className="top">
        <div className="left">
          <div className="hdgLine">
            <h2 className="skillsHdg">MY SKILLS</h2>
          </div>
        </div>
        <div className="right">
          <p>
        ...
        {skillsData.map((elem, idx) => {
          return (
            <div key={elem.id} className={`skillBar ${elem.aniClassName}`}>
              ...
              <div className="left">
                <p className="skillBarPara">{elem.id}</p>
                <h2 className="skillBarHdg">{elem.skill}</h2>
              </div>
              <div className="right skillBarLogo">{elem.logo}</div>
            </div>
          );
        })}
      </div>
